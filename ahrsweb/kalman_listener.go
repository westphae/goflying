...
func (kl *KalmanListener) update(s *ahrs.State, m *ahrs.Measurement) {
	...
	/*
	kl.data.DU1 = math.Sqrt(s.M.Get(0, 0))
	kl.data.DU2 = math.Sqrt(s.M.Get(1, 1))
	kl.data.DU3 = math.Sqrt(s.M.Get(2, 2))
	kl.data.DZ1 = math.Sqrt(s.M.Get(3, 3))
	kl.data.DZ2 = math.Sqrt(s.M.Get(4, 4))
	kl.data.DZ3 = math.Sqrt(s.M.Get(5, 5))
	kl.data.DE0 = math.Sqrt(s.M.Get(6, 6))
	kl.data.DE1 = math.Sqrt(s.M.Get(7, 7))
	kl.data.DE2 = math.Sqrt(s.M.Get(8, 8))
	kl.data.DE3 = math.Sqrt(s.M.Get(9, 9))
	kl.data.DH1 = math.Sqrt(s.M.Get(10, 10))
	kl.data.DH2 = math.Sqrt(s.M.Get(11, 11))
	kl.data.DH3 = math.Sqrt(s.M.Get(12, 12))
	kl.data.DN1 = math.Sqrt(s.M.Get(13, 13))
	kl.data.DN2 = math.Sqrt(s.M.Get(14, 14))
	kl.data.DN3 = math.Sqrt(s.M.Get(15, 15))

	kl.data.DV1 = math.Sqrt(s.M.Get(16, 16))
	kl.data.DV2 = math.Sqrt(s.M.Get(17, 17))
	kl.data.DV3 = math.Sqrt(s.M.Get(18, 18))
	kl.data.DC1 = math.Sqrt(s.M.Get(19, 19))
	kl.data.DC2 = math.Sqrt(s.M.Get(20, 20))
	kl.data.DC3 = math.Sqrt(s.M.Get(21, 21))
	kl.data.DF0 = math.Sqrt(s.M.Get(22, 22))
	kl.data.DF1 = math.Sqrt(s.M.Get(23, 23))
	kl.data.DF2 = math.Sqrt(s.M.Get(24, 24))
	kl.data.DF3 = math.Sqrt(s.M.Get(25, 25))
	kl.data.DD1 = math.Sqrt(s.M.Get(26, 26))
	kl.data.DD2 = math.Sqrt(s.M.Get(27, 27))
	kl.data.DD3 = math.Sqrt(s.M.Get(28, 28))
	kl.data.DL1 = math.Sqrt(s.M.Get(29, 29))
	kl.data.DL2 = math.Sqrt(s.M.Get(30, 30))
	kl.data.DL3 = math.Sqrt(s.M.Get(31, 31))
	*/
